...
case $numOfStatsFiles in
        ...
        python $pythonScript -p $delStats_folder -e -S $curr_year -E $curr_year -H twerp.rand.apnic.net
        ;;
        ...
        python $pythonScript -p $delStats_folder -e -i $delStats_folder/$statsForCurrYear -S $curr_year -E $curr_year -H twerp.rand.apnic.net
        ;;
