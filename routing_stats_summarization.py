...
import json, requests, getpass
        ...
        # TODO Summarize stats for ASes and prefixes and save to ElasticSearch
# Stats for ASes
# ['asn', 'del_date', 'asn_type', 'opaque_id', 'cc', 'region', 'isDead', 'UsageLatency', 'relUsedTime', 'effectiveUsage', 'timeFragmentation', 'avgPeriodLength', 'stdPeriodLength', 'minPeriodLength', 'maxPeriodLength', 'numOfPrefixesOriginated_curr', 'numOfPrefixesPropagated_curr']

# Stats for Prefixes
# ['prefix', 'del_date', 'resource_type', 'status', 'opaque_id', 'cc', 'region', 'mostRecentRoutingData_date', 'isRoutedIntact', 'isDead', 'isDeadIntact', 'originatedByDiffOrg', 'onlyRoot', 'rootMSCompl', 'rootMSIncompl', 'noRootMSCompl', 'noRootMSIncompl', 'UsageLatencyGral', 'UsageLatencyIntact', 'relUsedTimeIntact', 'avgRelUsedTimeGral', 'effectiveUsageIntact', 'avgEffectiveUsageGral', 'timeFragmentationIntact', 'avgTimeFragmentationGral', 'avgPeriodLengthIntact', 'stdPeriodLengthIntact', 'maxPeriodLengthIntact', 'minPeriodLengthIntact', 'avgPeriodLengthGral', 'stdPeriodLengthGral', 'maxPeriodLengthGral', 'minPeriodLengthGral', 'avgVisibility', 'stdVisibility', 'maxVisibility', 'minVisibility', 'avgASPathLength', 'stdASPathLength', 'maxASPathLength', 'minASPathLength', 'avgLevenshteinDist', 'stdLevenshteinDist', 'minLevenshteinDist', 'maxLevenshteinDist', 'currentVisibility', 'numOfOriginASes', 'numOfASPaths', 'numOfLessSpecificsRouted', 'numOfMoreSpecificsRouted', 'numOfCoveringMoreSpec', 'numOfCoveredLevel1MoreSpec', 'numOfCoveredLevel2MoreSpec', 'numOfSOSPMoreSpec', 'numOfSODP1MoreSpec', 'numOfSODP2MoreSpec', 'numOfDOSPMoreSpec', 'numOfDODP1MoreSpec', 'numOfDODP2MoreSpec', 'numOfDODP3MoreSpec', 'numOfLonelyMoreSpec']
